...
//   if yes, echo error account already exist
//   if not, save the user into db
// echo login button
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  try {
    ...
    try {
      ...
      if (is_string($result)) {
        // throw new PDOException('Username, email, or phone number already exists. Please try again.');
