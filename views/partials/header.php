<header
  class="bg-white border-b border-gray-200 pl-2 pr-6 py-2.5 dark:bg-gray-800 dark:border-gray-700 fixed left-0 right-0 top-0 z-50">
  <div class="flex flex-wrap justify-between items-center">
    <?php if ($uri !== '/login' && $uri !== '/register' && $uri !== '/'): ?>
      <div class="flex justify-start items-center">
        <form action="#" method="GET" class="pl-2">
          ...
          <div class="relative md:w-64 md:w-96">
            ...
            <input type="text" name="app-search" id="topbar-search"
    ...
    <div>
      <a href="/" class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Assocify</a>
    </div>
    ...
    <div class="flex items-center">
      <div class="text-gray-500">
        ...
        <?php endif; ?>
        <!-- TODO: Show Logout only if logged in -->
        <!-- TODO: Show Login/Register only if not logged in -->
      </div>
      <div class="flex items-center">
        <?php if ($uri !== '/login' && $uri !== '/register' && $uri !== '/'): ?>
          <!-- Notifications -->
          <button type="button" data-dropdown-toggle="notification-dropdown" id="notification-dropdown-btn"
          ...
          <button type="button"
            ...
            id="user-menu-btn" aria-expanded="false" data-dropdown-toggle="dropdown">
